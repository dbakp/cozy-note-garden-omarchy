...
echo "Installing Note Garden for the current user…"
...
command -v omarchy >/dev/null 2>&1 && omarchy notification send -i cozy-note-garden "Note Garden installed" "Open it from the Omarchy launcher." || true
